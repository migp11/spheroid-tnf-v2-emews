...
void tnf_boolean_model_interface_setup()
{
    ...
    tnf_bm_interface_info.cell_variables.push_back( "Survival_node" );
...
void update_boolean_model_inputs( Cell* pCell, Phenotype& phenotype, double dt )
{
    ...
    static float TNFR_receptors_per_cell = cell_defaults.custom_data["TNFR_receptors_per_cell"];
    ...
    float receptor_state =  pCell->custom_data[nR_EB] / TNFR_receptors_per_cell;
